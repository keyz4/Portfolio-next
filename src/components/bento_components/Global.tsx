...
function Global() {
  return (
    <div className="flex items-center justify-center h-full md:h-auto bg-black relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden md:h-[40rem] px-4 flex justify-center">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
